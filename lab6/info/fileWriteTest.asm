...
.data
    ...
    filePath db "C:\Users\UserLog.ru\Desktop\1234.txt", 0  ; содержит имя файла "1.txt"
    ab db "b4fv", 0 
.code 
start: 
    invoke CreateFileA, offset filePath, GENERIC_WRITE, 0, 0, OPEN_ALWAYS, FILE_ATTRIBUTE_NORMAL, 0 
    ...
    invoke WriteFile, fileHandler, offset ab, SIZEOF ab, offset numberOfBytesWritten, 0  
